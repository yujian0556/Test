...
static NSString * errorMessage (kxMovieError errorCode)
{
    ...
    switch (errorCode) {
        ...
        case kxMovieErrorOpenFile:
            ...
            return NSLocalizedString(@"无法打开文件", nil);
            
        case kxMovieErrorStreamInfoNotFound:
            return NSLocalizedString(@"无法找到流信息", nil);
            
        case kxMovieErrorStreamNotFound:
            return NSLocalizedString(@"找不到流", nil);
            
        case kxMovieErrorCodecNotFound:
            return NSLocalizedString(@"无法找到编解码器", nil);
            
        case kxMovieErrorOpenCodec:
            return NSLocalizedString(@"无法打开编解码器", nil);
            
        case kxMovieErrorAllocateFrame:
            return NSLocalizedString(@"无法分配框架", nil);
            
        case kxMovieErroSetupScaler:
            return NSLocalizedString(@"无法设置缩放器", nil);
            
        case kxMovieErroReSampler:
            return NSLocalizedString(@"无法设置重采样器", nil);
            
        case kxMovieErroUnsupported:
            return NSLocalizedString(@"不支持的能力", nil);
    }
}
...
#warning 不释放内存.有风险
    ...
    if (_videoFrame) {
        ...
        av_free(_videoFrame);   _videoFrame = NULL;

...
//    }
    ...
    if (self.isCase) {
        ...
        self.frame = CGRectMake(0, 0, imageW, totalRowCount * (kImagesMargin + h));
    }
    ...
    if (self.isHealthy) {
        ...
        self.frame = CGRectMake(30, 10, imageW, totalRowCount * (kImagesMargin + h));
    }else{
    
        self.frame = CGRectMake(0, 10, imageW, totalRowCount * (kImagesMargin + h));
    }
